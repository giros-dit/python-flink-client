...
class SubtaskCheckpointStatistics(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'CompletedSubtaskCheckpointStatistics': CompletedSubtaskCheckpointStatistics,
            'PendingSubtaskCheckpointStatistics': PendingSubtaskCheckpointStatistics,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, class_name, *args, **kwargs):  # noqa: E501
        """SubtaskCheckpointStatistics - a model defined in OpenAPI
