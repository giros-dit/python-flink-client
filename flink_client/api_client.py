...
from flink_client import rest
from flink_client.configuration import Configuration
from flink_client.exceptions import ApiTypeError, ApiValueError, ApiException
from flink_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cluster_delete  # this is an instance of the class Endpoint
        api_instance.cluster_delete()  # this invokes api_instance.cluster_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cluster_delete.callable or self.callable in this class
